...
const UserProfile = () => {
    ...
    useEffect(() => {
        ...
        const fetchUserData = async () => {
            try {
                const response = await axios.get(`https://52.87.247.113/estudiante/${id}`);
    ...
    const handleToggleStatus = () => {
        ...
        axios
          .put(`https://52.87.247.113/estudiante/${id}/cambiar-estatus`, { estatus: updatedStatus })
          .then((response) => {
        ...
        <div className="overflow-hidden bg-white shadow sm:rounded-lg">
            <div className="px-4 py-5 sm:px-6">
                ...
                <div className="flex items-center justify-between">
                    <img className="w-20 h-20 rounded-full" src={`https://52.87.247.113/${user.imagenPerfil}`} alt="Imagen de perfil" />
                                ...
                                <li className="flex items-center justify-between py-3 pl-3 pr-4 text-sm">
                                    ...
                                    <div className="ml-4 flex-shrink-0">
                                        <img
                                            ...
                                            src={`https://52.87.247.113/${user.imagenDocumento}`} alt="img" />
                                    </div>
                                </li>
                                <li className="flex items-center justify-between py-3 pl-3 pr-4 text-sm">
                                    <div className="flex w-0 flex-1 items-center">
                                    ...
                                    <div className="ml-4 flex-shrink-0">
                                        <img
                                            className="inline-flex border rounded-md border-gray-100 dark:border-gray-600 w-24 max-h-24 p-2 m-2"
                                            src={`https://52.87.247.113/${user.imagenVoleto}`} alt="img" />
                                    </div>
                                </li>
                                <li className="flex items-center justify-between py-3 pl-3 pr-4 text-sm">
                                    <div className="flex w-0 flex-1 items-center">
                                    ...
                                    <div className="ml-4 flex-shrink-0">
                                        <img
                                            className="inline-flex border rounded-md border-gray-100 dark:border-gray-600 w-24 max-h-24 p-2 m-2"
                                            src={`https://52.87.247.113/${user.imagenPermiso}`} alt="img" />
                                    </div>
                                </li>
                            </ul>
                        </dd>
